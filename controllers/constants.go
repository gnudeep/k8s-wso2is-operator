...
const containerImage string = "wso2/wso2is:7.3.0-beta"
...
const svcAccountName string = "wso2svc-account"

const usPvClaimName string = "user-store-pv-claim"
...
const pvcName string = "user-store-persistent-storage"
